...
<div class="container">
    ...
    <form method="post" action="">
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="text" id="title" name="title" placeholder="Tag Title" required>
            </div>
            @error('title')
        ...
        <div class="field">
            ...
            <div class="control">
                <textarea class="textarea" rows="10" id="description" name="description" placeholder="Tag Description" required></textarea>
            </div>
            @error('description')
            <p class="help is-danger">{{ $message }}</p>
            @enderror
